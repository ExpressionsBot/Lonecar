...
export default function ChatHeader({ currentChat }) {
  return (
    <header className="relative bg-navy text-light-gray p-4 shadow-md flex items-center justify-between flex-wrap border-b border-light-gray border-opacity-20" role="banner">
